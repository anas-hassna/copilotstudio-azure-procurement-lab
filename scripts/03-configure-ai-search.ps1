...
Call-Search "$searchEndpoint/indexers/$indexerName`?api-version=2024-05-01-preview" @"
{"name":"$indexerName","dataSourceName":"$dsName","targetIndexName":"$indexName","skillsetName":"$skillsetName","parameters":{"configuration":{"indexedFileNameExtensions":".pdf,.docx","dataToExtract":"contentAndMetadata"}},"fieldMappings":[{"sourceFieldName":"metadata_spo_site_library_item_id","targetFieldName":"id","mappingFunction":{"name":"base64Encode"}},{"sourceFieldName":"metadata_spo_item_name","targetFieldName":"title"}],"schedule":{"interval":"PT1H"}}
"@ "Indexer"
